...
optional<command_parameters_t> parse_parameters(int argc, char *argv[]) {
    ...
    vector<flag_t> flags{
        ...
        { "player-name", "n", po::value<string>(), true, "",
            [&](po::variables_map &vm) {
...
// player_name - imię gracza, które zostało podane podczas uruchomienia programu
...
public:
    ...
    // Metoda czytająca komunikat ACCEPTED_PLAYER i aktualizująca mapę graczy.
...
private:
    ...
    // Metoda wczytująca informacje o nowej bombie od serwera i aktualizująca
    // stan.
    ...
    // Metoda sprawdzająca, czy dane współrzędne mogą się znajdować na planszy.
